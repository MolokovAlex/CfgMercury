...
# Это случайные значения мгновенных параметров и профилей мощностей с 01.12.2022 по 30.06.2023. Размерность тестовых цифр - пока не важна -подключиться при backend-е.
